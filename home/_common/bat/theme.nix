...
<plist version="1.0">
  <dict>
    <key>name</key>
    <string>${config.colorScheme.slug}</string>
    <key>settings</key>
    <array>
      <dict>
        <key>settings</key>
        <dict>
          ...
          <string>#${base}</string>
          <key>caret</key>
          <string>#${subtext1}</string>
          <key>foreground</key>
          <string>#${text}</string>
          <key>invisibles</key>
          <string>#${overlay0}</string>
          <key>lineHighlight</key>
          <string>#${overlay1}</string>
          <key>selection</key>
          <string>#${surface2}</string>
        </dict>
      </dict>
      <dict>
        <key>name</key>
      ...
      <dict>
        ...
        <key>scope</key>
        <string>variable.other.constant, constant.character, constant.other</string>
        <key>settings</key>
        <dict>
          <key>foreground</key>
          <string>#${purple}</string>
    ...
    <string>theme.dark.${config.colorScheme.slug}.template</string>
    <key>author</key>
    <string>phdenzel</string>
  </dict>
</plist>'';
}
